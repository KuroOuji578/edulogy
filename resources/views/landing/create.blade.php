            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Edulogy</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Daftar Sekolah Edulogy</h4>
              <p class="mb-4">Ayo daftar di Edulogy High School</p>
              ...
              <form action="{{ route('landing.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input
                    type="text"
                    class="form-control {{ $errors->first('nama') ? "is-invalid":""}}" id="basic-default-fullname"
                    value="{{ old('nama')}}"
                    id="username"
                    name="nama"
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input
                      type="text"
                      class="form-control {{ $errors->first('alamat') ? "is-invalid":""}}" id="basic-default-fullname"
                      value="{{ old('alamat')}}"
                      name="alamat"
                ...
                <div class="mb-3 form-password-toggle">
                    <label class="form-label" for="password">Asal Sekolah</label>
                    <div class="input-group input-group-merge">
                      <input
                        type="text"
                        class="form-control"
